...
class Actions extends AbstractDisplayer
{
    ...
    {
        return <<<EOT
<a class="btn btn-waring btn-xs" href="{$this->getResource()}/{$this->getKey()}">
...
EOT;
    ...
    {
        return <<<EOT
<a class="btn btn-info btn-xs" href="{$this->getResource()}/{$this->getKey()}/edit">
...
SCRIPT;
        ...
        return <<<EOT
<a href="javascript:void(0);" data-id="{$this->getKey()}" class="{$this->grid->getGridRowName()}-delete btn btn-danger btn-xs">
